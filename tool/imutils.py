...
VOC12_MEAN_R = 122.67891434
VOC12_MEAN_G = 116.66876762
VOC12_MEAN_B = 104.00698793

VOC12_MEAN_RGB = np.array((VOC12_MEAN_R, VOC12_MEAN_G, VOC12_MEAN_B), dtype=np.float32)
VOC12_MEAN_BGR = np.array((VOC12_MEAN_B, VOC12_MEAN_G, VOC12_MEAN_G), dtype=np.float32)
